...
export const metadata: Metadata = {
  title: "Cerebras Presentation | Cafe Compute Delhi",
  description: "Cerebras introduction slides for Cafe Compute Delhi.",
};
  ...
  return (
    <main className="slides-page">
      <header className="slides-header">
        <Link className="slides-back" href="/">← Back to Cafe Compute</Link>
